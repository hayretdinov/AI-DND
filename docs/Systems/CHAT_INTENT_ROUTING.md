...
Monster scenes use the same router and input as intelligent encounters. Disabling NPC dialogue no longer disables combat text. Magic remains routed before ranged and melee actions; trade and training phrases remain outside combat.
